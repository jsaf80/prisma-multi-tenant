...
import { CliArguments, Command } from '../types.js'
import { clientManagementPath, PmtError } from '../../index.js'
...
const messageHelpCommand = (name: string): string =>
  `Run \`prisma4-multi-tenant ${name} --help\` to learn how to use this command`
