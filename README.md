...
<h2 align="center">Updated the dependencies for use with Prisma 4.7, changed the structure - removed workspaces and put everything in one package to work locally and not globally - and made a pure ESM Package. Something more todo before I'm able to pack it and publish at npm.</h2>
<p>All tests passed.</p>
<p>TODO ATM:
<ul>
<li>working on the docs</li>
<li>add prepare-deploy to help</li>
<li>checking if p4mt is installed while initiation.</li>
<li>new example</li>
<li>offering a second version with workspaces?</li>
